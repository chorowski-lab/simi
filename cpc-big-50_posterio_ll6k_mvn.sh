...
: ${POSTERIO_PATH:="/pio/gluster/santiago/posteriorograms/ll6k_50_mvn"}
CPC_CHECKPOINT="/pio/scratch/1/i323106/wav2vec/runs/cpc/cpc_big_ll6k/kmeansMVN/50clusters.pt"
