...
for VS in 100 ; do
    python segment.py \
        ...
        $VS \
        /pio/scratch/1/i290956/zs2021/simi/segmentations/${TRAINSET}_${TESTSET}_vs${VS}_a$1_test \
        --sentencepiece_prefix=/pio/scratch/1/i290956/zs2021/simi/sentencepieces/${TRAINSET}_vs${VS} \
